        ...
        <div className="w-full max-w-md bg-cyan-900 rounded-xl shadow-md py-8 px-8">
          ...
          <form className="flex flex-col">           
            <input
                ...
                className="bg-teal-50 text-cyan-900 border-0 rounded-md p-2  mb-4 focus:bg-teal-200 focus:outline-none transition ease-in-out duration-150 placeholder-cyan-900"
                type="text" />                
            <input
                placeholder="Email"
                className="bg-teal-50 text-cyan-900 border-0 rounded-md p-2  mb-4 focus:bg-teal-200 focus:outline-none transition ease-in-out duration-150 placeholder-cyan-900"
              ...
              <input
                ...
                <a className='text-teal-200 hover:underline mt-4 px-1' href='#'>Login</a></p>
